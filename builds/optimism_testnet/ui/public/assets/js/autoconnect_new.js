...
function createVideoIcon(link, font) {
	var i = ce("i");
	i.setAttribute("class", "bi bi-play-circle");
	font.append(i);
...
const o2watchHowToInstallMetamaskVideoText = "Watch this video on how to install Metamask"; 
...
function setInstallPlayList() {
	...
	connectVideoLinkSpan.append(createVideoLink(howToInstallMetamaskPlaylist, o2watchHowToInstallMetamaskVideoText, f));
