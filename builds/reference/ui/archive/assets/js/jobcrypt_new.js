...
async function getStakedAmount() {
    ...
    .then(function(response){
        console.log(response);
        var stakeStatusSpan = ge("stake_status_span"); 
        stakeStatusSpan.innerHTML = "<b><font color=\"green\"><i class=\"bx bx:lock-alt\"></i> STAKED ("+formatCurrency(response)+" "+stakeCurrencySymbol+")</font> </b>";
    })
    .catch(function(err){
        console.log(err);
    });
    ...
    .then(function(response) {
        ...
        stakeCurrencyAddress = response; 
            ...
            .then(function(response){
                ...
                stakeButtonSpan.innerHTML = "<small><a type=\"submit\" id=\"stake_button\" onclick=\"stake()\" class=\"btn btn-outline-success\">Stake</a></small></span>";                 
            })
            .catch(function(err){
                console.log(err);
            });
